...
';
		foreach ($userProjekts as $projekt) /* line 4 */ {
			...
			echo '</a></h2>
                ...
                <div id="projekt-buttons-container">
                    <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ProjektSetter:EditProjekt', [$projekt->id])) /* line 9 */;
			...
			echo LR\Filters::escapeHtmlAttr($projekt->id) /* line 12 */;
			echo '" style="display: none;"><a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Projekt:DeletProjekt', [$projekt->id])) /* line 12 */;
...
';
		...
		echo '        <div class="project-container">
            ...
            <div id="projekt-buttons-container">
                <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ProjektSetter:CreateProjekt')) /* line 20 */;
