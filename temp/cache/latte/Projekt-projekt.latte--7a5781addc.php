...
final class Template_7a5781addc extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['coment' => '39'], $this->params) as $ʟ_v => $ʟ_l) {
    ...
    <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('www')) /* line 10 */;
    ...
    <script>
        ...
        function generateQRCode() {
            ...
            let projektId = ';
		echo LR\Filters::escapeJs($projekt->id) /* line 24 */;
		echo ';
...
';
		foreach ($comentars as $coment) /* line 39 */ {
			echo '    <div id="coment">
        <h4>';
			echo LR\Filters::escapeHtmlText($coment->name) /* line 41 */;
			echo '</h4>
        <p>';
			echo LR\Filters::escapeHtmlText($coment->text) /* line 42 */;
			echo '</p>
    </div>
