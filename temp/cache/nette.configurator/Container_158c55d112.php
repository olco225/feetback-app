<?php
// source: C:\wamp64\www\Nette-projekt4/config/common.neon
// source: C:\wamp64\www\Nette-projekt4/config/services.neon
// source: array
...
class Container_158c55d112 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Feetback\FeetbackPresenter' => [2 => ['application.4']],
		'App\UI\Home\HomePresenter' => [2 => ['application.5']],
		'App\UI\Projekt\ProjektPresenter' => [2 => ['application.6']],
	...
	public function createService04(): App\Model\RegistrationFacade
	{
		return new App\Model\RegistrationFacade($this->getService('database.default.explorer'));
	}
	...
	public function createServiceApplication__4(): App\UI\Feetback\FeetbackPresenter
	{
	...
	public function createServiceApplication__5(): App\UI\Home\HomePresenter
	{
	...
	public function createServiceApplication__6(): App\UI\Projekt\ProjektPresenter
	{
		$service = new App\UI\Projekt\ProjektPresenter($this->getService('03'), $this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__7(): App\UI\ProjektSetter\ProjektSetterPresenter
	{
	...
	public function createServiceApplication__8(): App\UI\ProjektsPage\ProjektsPagePresenter
	{
	...
	public function createServiceApplication__9(): App\UI\Registration\RegistrationPresenter
	{
		$service = new App\UI\Registration\RegistrationPresenter($this->getService('04'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\wamp64\www\Nette-projekt4/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\Nette-projekt4/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\wamp64\www\Nette-projekt4/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_158c55d112
	{
		return $this;
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=evaluation',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/''/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_158c55d112 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\Nette-projekt4/temp/cache/latte');
